...
public class GotrPrePostScheduleRequirements extends PrePostScheduleRequirements{
    ...
    protected boolean initializeRequirements() {      
        ...
        ItemRequirementCollection.registerGracefulOutfit(this, RequirementPriority.RECOMMENDED, TaskContext.PRE_SCHEDULE);
        ...
        this.register(ItemRequirement.createOrRequirement(
            ...
            EquipmentInventorySlot.CAPE, -1, RequirementPriority.RECOMMENDED, 10, "Runecrafting cape (any variant)", TaskContext.PRE_SCHEDULE,
            Skill.RUNECRAFT, 99, null, null, false
        ));
        this.register(ItemRequirement.createOrRequirement(
            Arrays.asList(ItemID.SKILLCAPE_MINING, ItemID.SKILLCAPE_MINING_TRIMMED), 1,
            EquipmentInventorySlot.CAPE, -1, RequirementPriority.RECOMMENDED, 4, "Mining cape (any variant)", TaskContext.PRE_SCHEDULE,
