...
// HARPOON, BARBTAIL_HARPOON, DRAGON_HARPOON, INFERNAL_HARPOON, CRYSTAL_HARPOON
    ...
    DRAGON_HARPOON_OR_RELOADED(ItemID.DRAGON_HARPOON_OR_30349, AnimationID.FISHING_TRAILBLAZER_HARPOON, "Dragon harpoon reloaded (or)"),                
    ...
    INFERNAL_HARPOON_OR(ItemID.INFERNAL_HARPOON_OR_30342, AnimationID.FISHING_TRAILBLAZER_HARPOON, "Infernal harpoon (or)"),
    INFERNAL_HARPOON_OR_UNCHARGED(ItemID.INFERNAL_HARPOON_UNCHARGED_30343, AnimationID.FISHING_TRAILBLAZER_HARPOON, "Infernal harpoon uncharged (or)"),
