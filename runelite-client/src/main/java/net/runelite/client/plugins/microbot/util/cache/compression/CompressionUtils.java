...
public class CompressionUtils {
    ...
    public static CompressedData compressForProfile(String jsonData) {
        ...
        try {
            ...
            if (compressedSize > MAX_COMPRESSED_SIZE) {
                log.warn("Compressed cache data too large for profile storage: {} bytes (max: {} bytes)",
            ...
            // encode as base64 for profile storage
    ...
    public static class CompressedData {
        ...
        public boolean isValid() {
            return compressedData != null && compressedSize <= MAX_COMPRESSED_SIZE;
        }
