...
import net.runelite.client.plugins.microbot.agility.MicroAgilityPrePostScheduleRequirements;
            ...
            if (config.alchemy()) {
                ...
                if (items == null || config.itemsToAlch().trim().isEmpty()) {
                    ...
                    if (magicLevel < 55) {
                        ...
                        Microbot.getConfigManager().setConfiguration(agilityPluginConfigDescripor.getGroup().toString(), "alchemy", (boolean)false);
