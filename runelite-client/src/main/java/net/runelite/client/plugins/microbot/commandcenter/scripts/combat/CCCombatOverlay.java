...
public class CCCombatOverlay extends OverlayPanel {
    private final CCCombatScript script;

    @Inject
    public CCCombatOverlay(CCCombatScript script) {
        this.script = script;
